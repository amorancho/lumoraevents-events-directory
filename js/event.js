(function () {
  ...
  function buildPosterPlaceholder(eventName, countryName) {
    var svg = [
      ...
      '<text x="90" y="170" fill="#245f47" font-size="44" font-family="Georgia, serif">LumoraEvents</text>',
      '<text x="90" y="700" fill="#122019" font-size="82" font-family="Georgia, serif">' + escapeXml(eventName) + "</text>",
